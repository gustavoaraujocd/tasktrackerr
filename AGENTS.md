...
## Agente documentado
O projeto foi preparado para uso com Codex/ChatGPT como agente de apoio de geração e revisão de código, com estas instruções persistentes no repositório.
